...
class GradCAM:
    ...
    def __call__(self, inputs, class_indices=None, return_outputs=False):
        # pass inputs & backpropagate for selected class
        if inputs.dim() == 3:
