...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=100, lr=0.05, lr_min=1e-4, lr_factor=3, lr_patience=5, clipgrad=10000,
                 ...
                 logger=None, exemplars_dataset=None, all_outputs=False, **kwargs):
...
#         return torch.optim.SGD(params, lr=self.lr if t is None or t > 0 else self.first_lr, weight_decay=self.wd,
