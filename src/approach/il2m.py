...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=100, lr=0.1, lr_min=1e-4, lr_factor=3, lr_patience=10, clipgrad=10000,
                 ...
                 eval_on_train=False, logger=None, exemplars_dataset=None, **kwargs):
    ...
    def eval(self, t, val_loader):
        ...
        with torch.no_grad():
            ...
            for images, targets in val_loader:
                ...
                hits_taw, hits_tag, outputs = self.calculate_metrics(outputs, targets)
                # Log
    ...
    def calculate_metrics(self, outputs, targets):
        ...
        if self.ft_train:
            ...
            for m in range(len(pred)):
                this_task = (self.model.task_cls.cumsum(0) <= tensor_to_cpu(targets[m])).sum()
            ...
            outputs = rectified_outputs.tolist()
