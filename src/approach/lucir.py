...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=160, lr=0.1, lr_min=1e-4, lr_factor=10, lr_patience=8, clipgrad=10000,
                 ...
                 remove_less_forget=False, remove_margin_ranking=False, remove_adapt_lamda=False, **kwargs):
    ...
    def pre_train_process(self, t, trn_loader):
        ...
        if t == 0:
            ...
            # else:
            #     # Solved into networks.py by means of activate_features argument
            #     print("WARNING: ReLU is not removed from last block.")
