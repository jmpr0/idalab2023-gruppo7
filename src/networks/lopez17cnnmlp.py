...
class Lopez17CNNMLP(nn.Module):
    ...
    def __init__(self, in_channels=1, num_classes=10, **kwargs):
        ...
        if out_features_size is None:
            out_features_size = math.ceil(256 * scaling_factor)
        ...
        self.fc1 = nn.Linear(features_size0 * features_size1 * filters[1], 200)
        self.fc2 = nn.Linear(200, math.ceil(256 * scaling_factor))
