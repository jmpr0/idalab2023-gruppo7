...
def test_dataloader_multiple_datasets():
    args_line = "--exp-name local_test --approach finetuning --datasets mirage_generic --num-inputs 784 mirage_generic --num-inputs 784 mirage_generic --num-inputs 784" \
                " --network Wang17 --num-tasks 2 --batch-size 32" \
